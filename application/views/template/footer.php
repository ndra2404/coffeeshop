      ...
      <footer class="footer_section">
        <div class="footer_widget_area" style="background-image: url(<?php echo base_url()?>assets/images/backgrounds/bg_04.png);">
          <div class="container">
                ...
                <div class="footer_widget footer_about wow fadeInUp" data-wow-delay=".1s">
                  <div class="brand_logo">
                    <a class="brand_link" href="index_1.html">
                      <img src="<?php echo base_url()?>assets/images/logo/logo_black_1x.png" srcset="<?php echo base_url()?>assets/images/logo/logo_black_2x.png 2x" alt="logo_not_found">
                    </a>
                  </div>
              ...
              <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="footer_widget footer_contact wow fadeInUp" data-wow-delay=".2s">
                  ...
                  <ul class="ul_li_block">
                    <li><strong class="text-uppercase">Mail:</strong> ndra2404@gmail.com</li>
...
<!-- Mirrored from xpressrow.com/html/cafenod/index_3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 May 2022 10:39:38 GMT -->
</html>
