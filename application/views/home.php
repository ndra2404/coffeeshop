<section class="slider_section slider_light">
          <div class="container maxw_1720 position-relative">
            <div class="main_slider wow fadeInUp" data-wow-delay=".1s" data-slick='{"dots": false}' style="background-image: url(<?php echo base_url()?>assets/images/backgrounds/bg_09.png);">
              <div class="slider_item">
                <div class="row align-items-center justify-content-lg-between">
                  <div class="col-lg-5">
                    <div class="slider_image">
                      <img src="<?php echo base_url()?>assets/images/slider/img_02.png" alt="image_not_found" data-animation="fadeInUp" data-delay=".2s">
                    </div>
                  </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".1s">
                  <div class="item_icon">
                    ...
                    <img src="<?php echo base_url()?>assets/images/feature/icon_01.png" alt="icon_not_found">
                  </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".2s">
                  <div class="item_icon">
                    ...
                    <img src="<?php echo base_url()?>assets/images/feature/icon_02.png" alt="icon_not_found">
                  </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".3s">
                  <div class="item_icon">
                    ...
                    <img src="<?php echo base_url()?>assets/images/feature/icon_03.png" alt="icon_not_found">
                  </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".4s">
                  <div class="item_icon">
                    ...
                    <img src="<?php echo base_url()?>assets/images/feature/icon_05.png" alt="icon_not_found">
                  </div>
              ...
              <div class="col-lg-2 col-md-4 col-sm-6">
                <div class="feature_primary box_style wow fadeInUp" data-wow-delay=".5s">
                  <div class="item_icon">
                    ...
                    <img src="<?php echo base_url()?>assets/images/feature/icon_04.png" alt="icon_not_found">
                  </div>
