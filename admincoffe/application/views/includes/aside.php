      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview <?php echo $uri == 'produk' || $uri == 'kategori_produk' || $uri == 'satuan_produk' ? 'menu-open' : 'no' ?>">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="<?php echo site_url('kategoriproduk') ?>" class="nav-link <?php echo $uri == 'kategori_produk' ? 'active' : 'no' ?>">
        ...
        <li class="nav-item">
          <a href="<?php echo site_url('transaksi') ?>" class="nav-link <?php echo $uri == 'transaksi' ? 'active' : 'no' ?>">
            ...
            <p>Transaksi</p>
				...
				<li class="nav-item">
          <a href="<?php echo site_url('belum_bayar') ?>" class="nav-link <?php echo $uri == 'BelumBayar' ? 'active' : 'no' ?>">
            <i class="fas fa-money-bill nav-icon"></i>
            <p>Belum Bayar</p>
          </a>
        </li>
